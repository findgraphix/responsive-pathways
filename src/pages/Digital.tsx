      ...
      <main className="pt-24 pb-16">
        <section className="container mx-auto px-4 mb-16 reveal">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-semibold mb-4">Digital Transformation</h2>
          ...
          <div className="mt-12 p-6 bg-gray-50 rounded-lg shadow-md reveal">
            <h3 className="text-xl font-medium mb-4 text-center">Our Digital Transformation Approach</h3>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
              <div className="p-4">
                <div className="w-10 h-10 rounded-full bg-sky-blue/20 flex items-center justify-center mx-auto mb-3">
                  <span className="text-sky-blue font-medium">1</span>
                </div>
              ...
              <div className="p-4">
                <div className="w-10 h-10 rounded-full bg-sky-blue/20 flex items-center justify-center mx-auto mb-3">
                  <span className="text-sky-blue font-medium">2</span>
                </div>
              ...
              <div className="p-4">
                <div className="w-10 h-10 rounded-full bg-sky-blue/20 flex items-center justify-center mx-auto mb-3">
                  <span className="text-sky-blue font-medium">3</span>
                </div>
              ...
              <div className="p-4">
                <div className="w-10 h-10 rounded-full bg-sky-blue/20 flex items-center justify-center mx-auto mb-3">
                  <span className="text-sky-blue font-medium">4</span>
                </div>
